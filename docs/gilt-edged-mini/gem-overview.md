...
The primary objective is to better understand the price dynamics of a real-world portfolio comprising UK government interest-bearing instruments (Gilts) to effectively hedge the portfolio.

:::

The framework employs a cyclical, three-step methodology:

1. **Model and Policy Interplay**: Refine the strategies \- agent logics[^4] \- that define the interactions between *rule makers* and *rule takers* in the system[^5].  
...
1. You have constructive criticism about the GEM project, and / or  
2. you would like to discuss a *projection mode* scenario run, and / or  
3. you possess the knowledge and financial resources to take the GEM project in a direction that has meaning to you.
