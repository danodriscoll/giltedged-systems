...
> 
> Supposedly said by <cite>financial economist Alberto Giovannini</cite>.

GEM is open‑ended by design \- there is no fixed *end goal* for the evolution of the latest model. No *end goal* for iterative design of institutional structures or of any particular agent’s behaviour up to and including the government and central bank endogenous (*projection mode*) policy logics. The model is a simple, yet increasingly complex system with feedback loops, stocks, flows, and time delays. Model macro and agent-level outputs might, or might not, help us to better understand the institutional structures and behaviours that produce real-world economic time-series data. For instance, how can lagged system dynamics alone affect bond yields in periods when market expectations lack consensus?
...
The [latest model](/category/abmlp-x-structure) is written in the <Link to="https://www.python.org/">Python<svg width="13.5" height="13.5" aria-label="(opens in new tab)" class="iconExternalLink_nPIU"><use href="#theme-svg-external-link"></use></svg></Link> programming language using the project <Link to="https://mesa.readthedocs.io/stable/">Mesa<svg width="13.5" height="13.5" aria-label="(opens in new tab)" class="iconExternalLink_nPIU"><use href="#theme-svg-external-link"></use></svg></Link> framework. View a brief technical <Link to="https://www.data-reports.net/giltedged-info/studio-sketch/architecture.html">architecture<svg width="13.5" height="13.5" aria-label="(opens in new tab)" class="iconExternalLink_nPIU"><use href="#theme-svg-external-link"></use></svg></Link>. Model structures and logics may change at any time \- this is the ongoing <Link to="https://danodriscoll.github.io/">story and presentation<svg width="13.5" height="13.5" aria-label="(opens in new tab)" class="iconExternalLink_nPIU"><use href="#theme-svg-external-link"></use></svg></Link> of model, strategy and data application development.

Feel free to <Link to="mailto:daniel@giltedged.systems">get in touch<svg width="13.5" height="13.5" aria-label="(opens in new tab)" class="iconExternalLink_nPIU"><use href="#theme-svg-external-link"></use></svg></Link>.
...
[^3]:  Desan, [Making Money](/reading), p. 22
[^4]:  p. 69
[^5]:  pp. 311-319