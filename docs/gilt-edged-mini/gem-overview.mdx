...
Though GEM is open‑ended by design \- there is no fixed *end goal* for the evolution of any particular agent \- the development of the model's government and central bank endogenous (*projection mode*) policy logics is of particular interest.
